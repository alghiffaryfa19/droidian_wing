...
KERNEL_BOOTIMAGE_CMDLINE = androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 androidboot.usbcontroller=a600000.dwc3 swiotlb=2048 cgroup.memory=nokmem,nosocket loop.max_part=7 swapaccount=0 dhash_entries=131072 ihash_entries=131072 androidboot.hardware=winglm buildvariant=user console=tty0 droidian.lvm.prefer
...
# Defconfig to use
KERNEL_DEFCONFIG = winglm-droidian_defconfig
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/vendor/lge/*.dtbo
...
# recommended.
FLASH_INFO_CPU = Qualcomm Technologies, Inc SM7250

# Space-separated list of supported device ids as reported by fastboot
FLASH_INFO_DEVICE_IDS = winglm
